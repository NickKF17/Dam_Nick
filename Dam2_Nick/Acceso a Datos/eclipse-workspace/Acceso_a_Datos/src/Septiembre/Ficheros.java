...
public class Ficheros {
	...
	private static final String DIR_CONFIG="DAM2"+File.separator+"nick";
	...
	if(crearFichero==true) {
		CrearFichero(dirConfig);
	}


}
	public static void CrearFichero(File dirConfig) throws Exception{
		/*asi se hacia antes
		String respuesta="";
		try(FileWriter fw= new FileWriter(ARCHIVO_CONFIG,true)){ 
		if(fw==null)
		respuesta+="No he podido crear el archivo";
		else 
			respuesta+="Archivo creado o ya existia";
		}
